        ...
        <div class="relative p-4 rounded-lg shadow sm:p-5" :class="navbar.userNav ? 'bg-[#203843]' : 'bg-white'">
          ...
          <form :class="{ darkForm: navbar.userNav }">
            <div class="grid font-medium gap-4 mb-4 sm:grid-cols-2">
              ...
              <div>
                <label for="phone" class="block mb-2 text-sm">Tel: raqami</label>
              ...
              <div>
                <label for="category" class="block mb-2 text-sm font-medium"></label>
                <select id="category"
                  class="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">
                  <option selected disabled>Nimadur</option>
                  <option value="nimadur">Nimadur</option>
        ...
        <div class="relative shadow-md rounded-lg overflow-hidden" :class="navbar.userNav ? 'bg-[#203843]' : 'bg-white'">
          <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
              ...
              <tbody>
                <tr class="border-b hover:bg-gray-50" :class="navbar.userNav ? 'hover:bg-gray-700' : 'hover:bg-gray-50'
                  " v-for="i in 10" :key="i">
                  ...
                  <td class="text-center font-medium text-blue-800 px-8 py-2">
                    <p class="bg-blue-100 min-w-fit rounded-[5px] p-1 whitespace-nowrap">
                      Dasturiy ta'minot
                    </p>
                  </td>
                  ...
                  <td class="text-center font-medium px-8 py-3">
                    <button @click="enterSlug(i, 'Qobilov Shoxsuvor')"
          ...
          <nav class="flex flex-row justify-between items-center md:items-center space-y-3 md:space-y-0 p-4"
            ...
            <ul class="inline-flex items-stretch -space-x-px">
              <li>
                <a href="#"
                  class="flex font-bold text-black bg-white items-center justify-center text-sm py-2 sm:mt-0 -mt-2 px-6 rounded-lg leading-tight">Next</a>
              </li>
            </ul>
          </nav>
        </div>
