<template>
    <div class="container mx-auto p-5  bg-gray-50">
      ...
      :class=
      "modal ? 'overflow-y-auto flex bg-[rgba(0,0,0,0.5)] overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full'
        : 'hidden'
        ">
        ...
        <div class="w-full max-w-screen px-0 lg:p-0">
          ...
          <div
            ...
            <div class="w-full flex items-center gap-5">
              <h1 class="text-blue-700 font-semibold">Talabalar</h1>
              <div
