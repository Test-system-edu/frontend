                ...
                <div class="flex flex-col gap-3">
                    <div>
                        ...
                        <input type="text" id="login" v-model="form.login"
                            class="p-2 w-full sm:p-[10px] border rounded-[9px]" placeholder="Login" required />
                    </div>
                    <div>
                        <label for="password" class="block font-semibold">Parol</label>
                        <input type="password" id="password" v-model="form.password"
                            class="p-2 w-full sm:p-[10px] border rounded-[9px]" placeholder="••••••••" required />
                    </div>
                    <div>
                        <label for="fullname" class="block font-semibold">F. I. O.</label>
                        <input type="fullname" id="fullname" v-model="form.full_name"
                            class="p-2 w-full sm:p-[10px] border rounded-[9px]" placeholder="To'liq ism" required />
                    </div>
                    <div>
                        <label for="phone" class="block font-semibold">Telefon raqam</label>
                        <input type="phone" id="phone" v-model="form.phone_number"
                            class="p-2 w-full sm:p-[10px] border rounded-[9px]" placeholder="+99899-------" required />
                    </div>
                </div>
                <button type="submit"
